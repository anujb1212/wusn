 ...
 * }
 */
export async function getIrrigationDecisionController(req, res) {
    try {
 ...
 */
export async function getIrrigationRecommendationsController(req, res) {
    try {
        ...
        if (minUrgency) {
            const urgencyLevels = ['NONE', 'LOW', 'MODERATE', 'HIGH', 'CRITICAL'];
...
//# sourceMappingURL=irrigation.controller.js.map